...
function logoNeedsBackground($file)
{
	...
	if(isset($image))
	{
		...
		// 750 will be the threshold, if the average color is above this value, we consider the logo to be too bright and we need a background color to see it, otherwise we won't see it on a white background
